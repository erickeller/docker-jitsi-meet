...
iptables -t nat -A PREROUTING -i ${INTERFACE} -p tcp --dport 5280 -j DNAT --to ${TARGET_IP}:5347
...
iptables -t nat -A PREROUTING -i ${INTERFACE} -p udp --dport 10000:10020 -j DNAT --to ${TARGET_IP}:10000-10020
